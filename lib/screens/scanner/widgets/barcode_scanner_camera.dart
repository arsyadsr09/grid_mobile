// This is custom widget from ai_barcode_scanner
// and just have some update customized params and orientation
// if you have something just ask to Arsyad Ramadhan
...
part '_custom_overlay_shape.dart';
...
class BarcodeScannerCamera extends StatefulWidget {
  ...
  const BarcodeScannerCamera({
    ...
    this.scanWindow,
    this.startDelay,
    this.onlyFrontCamera = false,
    this.isBgTransparent = false,
    this.hintWidget,
    @Deprecated(
        'Use [validator] instead. This will be removed in next version.')
    this.validateText,
    @Deprecated(
        'Use [validator] instead. This will be removed in next version.')
    this.validateType,
  ...
  @override
  State<BarcodeScannerCamera> createState() => _BarcodeScannerCameraState();
}
...
class _BarcodeScannerCameraState extends State<BarcodeScannerCamera> {
  ...
  void onScannerStarted(MobileScannerArguments? args) {
    if (widget.onScannerStarted != null) {
      widget.onScannerStarted!(args);
    }
  ...
  Future<void> checkCameraState() async {
    ValueNotifier<CameraFacing>? cameraFacing =
        widget.controller?.cameraFacingState;
                ...
                shape: _CustomOverlayShape(
                  ...
                  borderColor: ((_isSuccess ?? false) && widget.showSuccess)
                      ...
                      : (!(_isSuccess ?? true) && widget.showError)
                          ? widget.errorColor
                          : widget.borderColor,
                  isBgTransparent: widget.isBgTransparent,
